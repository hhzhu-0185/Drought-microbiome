---
title: "Fig.3g & Fig.S8_Enriched fungal and Bacillota OTUs in HMMS"
author: "Huanhuan Zhu"
date: "2025-09-30"
...
## Fig.S8_Enriched Bacillota OTUs in HMMS
```{r, fig.align='center', fig.height=5.2, fig.width=10, warning=FALSE, message=FALSE}

##############Fig.3g & Fig.S8_Enriched fungal and prokaryotic OTUs in HMMS############
...
ggplot(df2[df2$V5_02 == "Bacillota", ], aes(x = coef, y = abundance, color = factor(V5_06))) +
...
## Fig.3g_Enriched fungal OTUs in HMMS
...
ggplot(df2, aes(x = coef, y = abundance, color = factor(V5_6, levels = rev(c("Talaromyces", "Trichoderma", "Humicola", "Rhodotorula","Naganishia", "Lecythophora", 
