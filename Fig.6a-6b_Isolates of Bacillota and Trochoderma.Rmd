---
title: "Fig.6a-6b_Isolates of Bacillota and Trochoderma"
author: "Huanhuan Zhu"
date: "2025-09-19"
...
## Fig.6a_Isolates of Bacillota
```{r, fig.align='center', fig.height=8, fig.width=11, warning=FALSE, message=FALSE}
...
# tree file
isolate_tree <- ggtree::read.tree("E:/HMME/Amplicon/5-strain screeing/final tree/bacteria/bacteria_filtered.nwk")
...
p3 <- p2 +
  ...
  theme(plot.margin = margin(r = 50),
    ...
    legend.position = "bottom",  # 更靠右一些
    legend.justification = c(0, 0.5),  # 对齐方式
    legend.background = element_rect(fill = "transparent")  # 可选：透明背景
        )
...
ggplot(fungi_strain, aes(y = factor(Genus, levels = rev(Genus)), x = Freq, fill = factor(Genus))) + 
  geom_col(width = 0.6) +
